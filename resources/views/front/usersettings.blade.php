                    ...
                    <div class="order-form col-md-6 col-xs-12 text-right">
                        ...
                        {!! Form::open(['method'=>'post', 'files'=>true, 'url'=>'/userupdate/'.$user->id]) !!}
                            ...
                            <div class="order-item col-xs-12">
                                ...
                                <input type="text" name="password"  placeholder="كلمة المرور القديمة هنا">
                            </div>
                            <!-- end order-item -->
                            <div class="order-item col-xs-12">
                                <h1>
                                ...
                                <input type="text" name="newpass" placeholder="كلمة المرور الجديدة هنا">
                            </div>
                            <!-- end order-item -->
                            <div class="order-item col-xs-12">
                                <h1>
                                ...
                                <input type="text" name="newpass_confirmation" placeholder="إعادة كلمة المرور الجديدة هنا">
                            </div>
                            <!-- end order-item -->
                            <div class="order-item col-xs-12">
                                <h1>
